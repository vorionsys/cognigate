...
NPM_PACKAGES: dict[str, dict[str, str]] = {
    "vorion": {
        ...
        "council": "@vorionsys/council",
        "a3i": "@vorionsys/a3i",
        "aiGateway": "@vorionsys/ai-gateway",
        "runtime": "@vorionsys/runtime",
        "platformCore": "@vorionsys/platform-core",
        "n8nNodesCognigate": "@vorionsys/n8n-nodes-cognigate",
    },
    "vorionSys": {
        "sdk": "@vorionsys/sdk",
